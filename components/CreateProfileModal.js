...
function CreateProfileModal() {
	...
	return (
		<Modal 
			...
			onClose={onClose}>
			<ModalOverlay  />
			<ModalContent alignItems='center' background={"#F9F9C5"}>
				<ModalHeader color={"#F37878"}>Create Profile</ModalHeader>
				<ModalBody width='100%'>
					<VStack 
					width='100%'
					background={"#F9F9C5"} >
						<FormControl width='100%'>
							<FormLabel htmlFor='handle' color={"#F37878"}>Handle</FormLabel>
							<Input 
								id='handle'
								value={handle}
								onChange={(e) =>
						...
						<FormControl width='100%'>
							<FormLabel htmlFor='pfp' color={"#F37878"}>
								Profile Picture URI
							</FormLabel>
							<Input
								value={pfp}
						...
						<FormControl width='100%'>
							<FormLabel htmlFor='follow' color={"#F37878"}>
								Follow NFT URI
							</FormLabel>
							<Input
								value={followPfp}
						...
						<FormControl width='100%'  color={"#F37878"}>
							<FormLabel htmlFor='followModule' color={"#F37878"} >
								Follow Module
							</FormLabel>
							{enabledModules !== null ? (
								<Select 
				...
				<ModalFooter>
					<Button onClick={createProfileRequest} background={"#F37878"}>Create</Button>
				</ModalFooter>
			</ModalContent>
		</Modal>
	);
