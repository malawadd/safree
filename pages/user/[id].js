...
export default function Profile() {
	...
	return (
		<Grid py='74px' background={"#F9F9C5"}>
			{profile != null ? (
				<VStack spacing={0}>
					...
					<Grid background={"#F9F9C5"}
						width='100%'
						padding={5}
						gridGap={5}
						templateColumns='1fr 4fr'>
						<VStack background={"#F9F9C5"} 
						borderColor={"#F37878"}
							width='100%'
							...
							<VStack
								...
								<Text fontSize='2xl' fontWeight='600' color={"#F37878"}>
									{profile.name}
								</Text>
								<Text color={"#F37878"}>@{profile.handle}</Text>
								<HStack spacing={5} >
									<VStack
										spacing={0}
										width='100%'
						...
						<VStack
							...
							<Tabs
								...
								colorScheme='red'>
								<TabList >
									<Tab color={"#F37878"}>Posts</Tab>
									<Tab color={"#F37878"}>Comments</Tab>
									<Tab color={"#F37878"}>Mirrors</Tab>
								</TabList>
								<TabPanels>
									<TabPanel>
