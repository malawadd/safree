...
export default function Settings() {
	...
	return (
		<>
			...
			>
				<VStack spacing={4} alignItems="flex-start" width="100%" color={"#F37878"}>
					<FormControl>
